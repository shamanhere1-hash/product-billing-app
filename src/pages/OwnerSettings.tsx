    ...
    <div className="page-container">
      ...
      <div className="max-w-md mx-auto space-y-6">
          ...
          {changingPin === 'main_app' ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => { setChangingPin(null); setNewPin(''); setConfirmPin(''); }} className="flex-1">
                  Cancel
                </Button>
                <Button onClick={() => handleChangePin('main_app')} disabled={loading} className="flex-1">
          ...
          {changingPin === 'history_summary' ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={() => handleChangePin('history_summary')} disabled={loading} className="flex-1">
                  {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Save'}
                </Button>
              </div>
            </div>
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            This PIN grants access to owner settings and can change all other PINs.
          </p>
          ...
          {changingPin === 'owner' ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={() => handleChangePin('owner')} disabled={loading} className="flex-1">
                  {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Save'}
                </Button>
              </div>
            </div>
          ) : (
            <Button onClick={() => setChangingPin('owner')} variant="outline" className="w-full">
              Change Owner PIN
            </Button>
          )}
        </div>
