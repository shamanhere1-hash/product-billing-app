...
import { format, startOfMonth, endOfMonth, startOfDay, isSameDay, isSameMonth, addMonths, subMonths, getDay, getDaysInMonth } from "date-fns";
...
function calcOrderProfit(order: Order, productMap: Map<string, Product>): number {
...
export default function Profit() {
    ...
    const dailyProfitMap = useMemo(() => {
        const map = new Map<string, { profit: number; orders: Order[] }>();
        billedOrders.forEach((order) => {
            ...
            if (existing) {
                ...
                map.set(dateKey, { profit, orders: [order] });
            }
        });
        return map;
    ...
    // Max profit in displayed month for color scaling
    ...
    const getGreenStyle = (profit: number): string => {
        ...
        // Scale lightness from 85% (low) to 30% (high)
        ...
        <div className="page-container">
            ...
            <div className="page-header flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <BackButton />
                    <h1 className="page-title mb-0">Profit</h1>
                </div>
                <button
                    ...
                    {selectedDay && selectedDayData && (
                        <>
                            <SheetHeader>
                                ...
                                <SheetDescription className="text-green-500 font-bold text-base">
                                    Profit: ₹{selectedDayData.profit.toFixed(2)}
                                </SheetDescription>
                            </SheetHeader>
                                ...
                                {selectedDayData.orders.map((order) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <button
                                                onClick={() =>
                                                    setExpandedBillId(isExpanded ? null : order.id)
                                                }
